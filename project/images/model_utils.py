...
class PointGenerationTypes(models.TextChoices):
    SIMPLE = 'm', "Simple Random (Random within the entire annotation area)"
    STRATIFIED = (
        't', "Stratified Random (Random within a cell of the annotation area)")
...
class PointCreationTypes(models.TextChoices):
    ...
    IMPORTED = 'i', "Imported (Not generated by CoralNet)"
