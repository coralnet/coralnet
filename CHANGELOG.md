...
Production: 2026-04-25

## [1.25.2](https://github.com/coralnet/coralnet/tree/1.25.2)

Production: 2026-03-19

## [1.25.1](https://github.com/coralnet/coralnet/tree/1.25.1)

Production: 2026-03-17

## [1.25](https://github.com/coralnet/coralnet/tree/1.25)

Production: 2026-02-28 to 03-15 (score query improvements 03-10, migrations across this whole range)
...
- New migrations to run, mainly converting ID fields from 4 bytes to 8 bytes: accounts 0013, annotations 0036-0037, api_core 0014, blog 0005, calcification 0005, errorlogs 0002, events 0005, images 0052-0054, jobs 0020, labels 0006-0007, newsfeed 0003, sources 0011-0012, vision_backend 0028-0030
  ...
  - The longest ones to run in production are the ones that involve updating foreign-key columns in the Score table (the biggest table): images 0053-0054, labels 0007, and sources 0012. Each of those took about 3-4 hours to run.
